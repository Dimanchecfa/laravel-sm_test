        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-lg{{ $category->id }}">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="#" class="btn btn-primary btn-sm" data-toggle="modal"
                                        data-target="#modal-lg{{ $product->id }}"> <i class=" fas fa-eye">
                                        </i>
                                        View
                                    </a>
                                    <a href="#" class="btn btn-info btn-sm" data-toggle="modal"
                                        data-target="#modal-xl{{ $product->id }}">
